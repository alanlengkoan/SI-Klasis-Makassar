...
class TbGerejaRepository extends ServiceEntityRepository
{
    ...
    {
        $sql = "SELECT g.id_gereja, g.alamat, g.tentang, g.telepon, g.twitter, g.instagram, g.facebook, g.youtube, g.lat, g.lon, u.nama, u.email, u.foto, u.username FROM App\Entity\TbGereja g LEFT JOIN App\Entity\User u WITH g.id_gereja = u.id_users ORDER BY g.upd DESC";
    ...
    {
        $sql = "SELECT g.id_gereja, g.jadwal_ibadah, g.alamat, g.tentang, g.telepon, g.twitter, g.instagram, g.facebook, g.youtube, g.lat, g.lon, u.nama, u.email, u.foto, u.username FROM App\Entity\TbGereja g LEFT JOIN App\Entity\User u WITH g.id_gereja = u.id_users WHERE u.id_users='$id'";

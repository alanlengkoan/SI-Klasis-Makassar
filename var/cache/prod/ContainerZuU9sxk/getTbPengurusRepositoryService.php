 ...
 */
class getTbPengurusRepositoryService extends App_KernelProdDebugContainer
{
    /**
     * Gets the private 'App\Repository\TbPengurusRepository' shared autowired service.
     *
     * @return \App\Repository\TbPengurusRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TbPengurusRepository.php';

        return $container->privates['App\\Repository\\TbPengurusRepository'] = new \App\Repository\TbPengurusRepository(($container->services['doctrine'] ?? $container->getDoctrineService()), ($container->services['doctrine.orm.default_entity_manager'] ?? $container->load('getDoctrine_Orm_DefaultEntityManagerService')));
    }
}

 ...
 */
class getTbKeuanganRepositoryService extends App_KernelProdDebugContainer
{
    /**
     * Gets the private 'App\Repository\TbKeuanganRepository' shared autowired service.
     *
     * @return \App\Repository\TbKeuanganRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TbKeuanganRepository.php';

        return $container->privates['App\\Repository\\TbKeuanganRepository'] = new \App\Repository\TbKeuanganRepository(($container->services['doctrine'] ?? $container->getDoctrineService()), ($container->services['doctrine.orm.default_entity_manager'] ?? $container->load('getDoctrine_Orm_DefaultEntityManagerService')));
    }
}

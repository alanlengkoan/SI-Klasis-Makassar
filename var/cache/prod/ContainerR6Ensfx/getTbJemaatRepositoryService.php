 ...
 */
class getTbJemaatRepositoryService extends App_KernelProdContainer
{
    /*
     * Gets the private 'App\Repository\TbJemaatRepository' shared autowired service.
     *
     * @return \App\Repository\TbJemaatRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TbJemaatRepository.php';

        return $container->privates['App\\Repository\\TbJemaatRepository'] = new \App\Repository\TbJemaatRepository(($container->services['doctrine'] ?? $container->getDoctrineService()), ($container->services['doctrine.orm.default_entity_manager'] ?? $container->load('getDoctrine_Orm_DefaultEntityManagerService')));
    }
}

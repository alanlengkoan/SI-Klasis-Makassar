...
";
    ...
    <div class=\"row\">
        ...
        // line 22
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 22, $this->source); })()), "user", [], "any", false, false, false, 22), "nama", [], "any", false, false, false, 22), "html", null, true);
        echo "</strong>.</p>
                </div>
            </div>
        </div>
...
";
    ...
    {
        return array (  128 => 31,  111 => 22,  104 => 17,  101 => 15,  94 => 10,  89 => 7,  79 => 5,  60 => 3,  37 => 1,);
    }
...
<div class=\"container-fluid\">
    <div class=\"row\">
        <div class=\"col-12\">
            <div class=\"card\">
                <div class=\"card-body\">
                    <p>Selamat datang <strong>{{ app.user.nama }}</strong>.</p>
                </div>
            </div>
        </div>
    </div>
...
{% block javascripts %}{% endblock %}", "admin/dashboard/view.html.twig", "P:\\Project\\PHP\\si\\SI-Klasis-Makassar\\templates\\admin\\dashboard\\view.html.twig");
    }
}
